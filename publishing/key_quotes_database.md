...
| Pilot failure rate                | 90%                        | David (Qurrent)          | Enterprise Blockers   |
| Framework abandonment             | 80-90%                     | Cynthia (WiseAgents)     | Framework/Tooling     |
| Integration time                  | 40-50% of deployment       | David (Qurrent)          | System Integration    |
| Model contribution                | 30-40%                     | Manus Fireside           | Model Capabilities    |
| Context utilization rule          | 40% max                    | Production Agents Summit | Context Management    |
| MCP tool accuracy cliff           | 25 tools = 30% accuracy    | CC (Vivgrid)             | System Integration    |
| Demo-to-production gap            | 70% reliability threshold  | Mrinal (Autonomy)        | Probabilistic Systems |
| Custom framework speed            | 3-4x faster than LangChain | Sahil (Clientell)        | Framework/Tooling     |
| Coding agent productivity         | 3x gains                   | Tian (Okta)              | Model Capabilities    |
| Cost disadvantage (generic tasks) | 3-5x vs human labor        | Tian (Okta)              | Enterprise Blockers   |
...
- **Status**: public
- **Key Data Point**: 3-4x faster than LangChain
...
> -- Cece (Visigrate), Why 95% Fail Conference
...
- **Status**: public
- **Key Data Point**: 80-90% abandon LangChain for production

**2. Framework Skepticism** - Impact: 4/5

> "I wouldn't build an agent and put it into production with LangChain or any of the existing frameworks."
> -- Yujian Tan
...
- [x] **90%** - Pilot failure rate (David/Qurrent)
- [x] **80-90%** - Framework abandonment rate (Cynthia/WiseAgents)
- [x] **40-50%** - Integration time of deployment (David/Qurrent)
- [x] **30-40%** - Model contribution (Manus Fireside)
- [x] **25-tool** - MCP limit before accuracy cliff (CC/Vivgrid)
- [x] **30%** - Accuracy drop beyond 25 tools (CC/Vivgrid)
- [x] **40%** - Context utilization rule (Production Agents Summit)
- [x] **70%** - Demo reliability threshold (Mrinal/Autonomy)
- [x] **3-4x** - Custom framework speed advantage (Sahil/Clientell)
- [x] **3x** - Coding agent productivity gains (Tian/Okta)
- [x] **3-5x** - Cost disadvantage vs human labor (Tian/Okta)
...
- **David (Qurrent)** - Enterprise AI agent deployment
- **Mrinal Wadhwa (Autonomy)** - Probabilistic systems and expectation management
- **CC Fan (Vivgrid)** - MCP scalability and enterprise challenges
- **Cynthia (WiseAgents)** - Framework ecosystem and abandonment patterns
- **Sahil (Clientell)** - Custom framework development
- **Mehak (Sybill)** - Evaluation methodologies and data compression
- **Tian Lan (Okta)** - Enterprise identity and pricing
- **Tushar (CodeForge)** - Coding agents and model capabilities
- **Manus Co-Founder** - Model contribution and multi-model orchestration
- **Saurav (RunLLM)** - Observability and memory architecture
- **Abhishek (Apna)** - Voice AI and enterprise trust
- **Yujian Tan** - Framework skepticism and production reality
- **Stephen (GMI)** - Evaluation tool market
- **Joao (CrewAI)** - Enterprise topology and geographic strategy
- **VCatTheory (VC)** - Investment perspective and organizational change
