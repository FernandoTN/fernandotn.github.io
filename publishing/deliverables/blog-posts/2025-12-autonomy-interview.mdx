...
summary: 'Mrinal Wadhwa on why 30 years of deterministic software conditioning creates expectation mismatches with AI agents, and the scientific approach needed to bridge the gap.'
...
image: '/images/blog/autonomy-probabilistic-systems.png'
---
...
In October 2024, I sat down with Mrinal Wadhwa, Founder and CEO of Autonomy, to discuss what he sees as the fundamental challenge blocking AI agent adoption. Mrinal has spent years building distributed systems and now leads a company focused on helping teams move from AI prototypes to production. His perspective cuts to the heart of why 90% of AI agent pilots never convert to production deployments.

What emerged from our conversation was not a discussion of model capabilities or prompt engineering techniques. Instead, Mrinal articulated a paradigm shift that most organizations have yet to recognize: the move from deterministic to probabilistic systems requires fundamentally different approaches to building, testing, and managing expectations. The technology works. The problem is that we do not know how to work with it.
...
Why do these expectation mismatches occur so consistently? According to Mrinal, it comes down to three decades of conditioning.
...
When organizations attempt to productionize their impressive demos, they typically enter what Mrinal describes as a "doom loop" of futile improvement attempts:
...
Mrinal argues that escaping the doom loop requires adopting methodologies borrowed from science rather than traditional software engineering:
...
The irony, Mrinal notes, is that even traditional software engineering has poor testing discipline. He estimates that only about 20% of software projects have comprehensive automated testing. Expecting the same developers to adopt rigorous evaluation practices for probabilistic systems is ambitious. Yet without this discipline, production deployment remains out of reach.

## Organizational Openness to Change

Despite these challenges, Mrinal observes a surprising willingness among organizations to adopt new approaches. The fear of being disrupted is driving faster adoption than anyone anticipated. Organizations from startups to banks are fundamentally reconsidering their workflows and are willing to deploy agent-based systems into production faster than he expected.
...
The probabilistic systems challenge is not going away. As Mrinal put it:
...
Based on Mrinal's insights, here are actionable recommendations for managing stakeholder expectations and succeeding with probabilistic systems:
...
As Mrinal Wadhwa demonstrates, the tools and architectures for reliable AI agents exist today. The question is whether organizations can evolve their thinking fast enough to use them.
