...
6. **Framework & Tooling Ecosystem** — LangChain, orchestration libraries, observability tools
...
| ----- | --------------------------------------------------------------------------------- |
| 1     | Qurrent (David), Autonomy (Mrinal), GMI (Stephen), Clientell (Sahil), Yujian Tan  |
| 2     | Okta (Tian), CodeForge (Tushar), Sybill (Mehak), Apna (Abhishek), RunLLM (Saurav) |
| 3     | Vivgrid (CC), WiseAgents (Cynthia), ChatPRD, CrewAI, Roblox                       |
