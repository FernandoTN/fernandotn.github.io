# Cross-Linking Verification Report

**Generated:** 2025-12-03
**Scope:** 25 blog posts in `/Users/fernandotn/Downloads/390/publishing/deliverables/blog-posts/`

---

## Internal Links Found

| Source Post                               | Links To                          | Status                               |
| ----------------------------------------- | --------------------------------- | ------------------------------------ |
| 2025-12-ai-agents-research-overview.mdx   | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-system-integration-92-percent.mdx | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-40-percent-context-rule.mdx       | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-framework-abandonment.mdx         | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-demo-production-chasm.mdx         | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-enterprise-business-case.mdx      | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-coding-agent-exception.mdx        | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-model-myth.mdx                    | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-dual-memory-architecture.mdx      | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
| 2025-12-mcp-tool-cliff.mdx                | /blog/ai-agents-research          | BROKEN - Target path mismatch        |
...
The anchor publication file is named:

```
2025-12-ai-agents-research-overview.mdx
```

This would typically render as URL:

```
/blog/ai-agents-research-overview
```

However, 23 posts link to:

```
/blog/ai-agents-research
```

This path does NOT match the filename of any existing blog post.

### One Correct Link

Only `2025-12-repo-patcher.mdx` correctly links to `/blog/ai-agents-research-overview`, which matches the anchor publication filename.

---

## Recommended Cross-Links

The current blog post series has minimal cross-linking beyond the footer reference to the overview. Consider adding thematic cross-links:
...
All 23 broken links must be updated from:
...
**OR** alternatively, if the website routing supports it, create a redirect from `/blog/ai-agents-research` to `/blog/ai-agents-research-overview`.
...
1. 23 of 24 internal links (96%) are broken due to path mismatch
2. Only 1 post correctly links to the anchor publication

**Recommended Actions:**

1. **Immediate:** Fix the 23 broken footer links to use `/blog/ai-agents-research-overview`
2. **Enhancement:** Add thematic cross-links between related posts (see table above)
3. **Optional:** Set up a redirect from `/blog/ai-agents-research` to `/blog/ai-agents-research-overview`

---

## Appendix: All Blog Post Filenames and Expected URLs

| Filename                                  | Expected URL Path                   |
| ----------------------------------------- | ----------------------------------- |
| 2025-12-ai-agents-research-overview.mdx   | /blog/ai-agents-research-overview   |
| 2025-12-system-integration-92-percent.mdx | /blog/system-integration-92-percent |
| 2025-12-40-percent-context-rule.mdx       | /blog/40-percent-context-rule       |
| 2025-12-framework-abandonment.mdx         | /blog/framework-abandonment         |
| 2025-12-demo-production-chasm.mdx         | /blog/demo-production-chasm         |
| 2025-12-enterprise-business-case.mdx      | /blog/enterprise-business-case      |
| 2025-12-coding-agent-exception.mdx        | /blog/coding-agent-exception        |
| 2025-12-model-myth.mdx                    | /blog/model-myth                    |
| 2025-12-dual-memory-architecture.mdx      | /blog/dual-memory-architecture      |
| 2025-12-mcp-tool-cliff.mdx                | /blog/mcp-tool-cliff                |
...
_Note: Expected URL paths assume the website strips the date prefix and file extension from the filename._
