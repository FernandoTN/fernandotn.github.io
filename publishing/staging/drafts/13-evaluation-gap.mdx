...
This disconnect explains why Manus abandoned industry benchmarks entirely—standard metrics weren't "even close to real user's requirements." They had to build custom evaluation from real-world usage data, a path that doesn't scale across the ecosystem.
...
Yujian Tan, an investor and AI practitioner, captured this precisely:
...
> — Cece, Co-founder & CEO of Visigrate, "Why 95% Fail" conference
...
Mehak from Sybill, a sales AI company, articulated this counterintuitive approach:
...
This prevents the "doom loop" described by Mrinal Wadhwa at Autonomy: fixing one scenario while breaking three others. Continuous evaluation maintains baselines while enabling iteration.
