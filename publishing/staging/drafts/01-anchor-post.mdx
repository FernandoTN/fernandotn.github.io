...
- Open with the striking 90% pilot failure statistic (David/Qurrent)
...
- 90% of enterprise AI agent pilots never convert to production (David/Qurrent)
- Demos work 70% of the time, which is enough to impress but systematically fails in production (Mrinal/Autonomy)
...
- **36 Expert Interviews**: Practitioners actively deploying agentic workflows
  - Enterprise AI platform providers (Qurrent, Autonomy, RunLLM)
  - Coding agent developers (CodeForge)
  - Identity and security experts (Okta team member)
  - Vertical SaaS companies (Sybill, Clientell, Apna)
  - Framework companies (CrewAI, Wise Agents)
  - Infrastructure providers (Vivgrid)
