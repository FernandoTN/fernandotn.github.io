---
title: 'Why Coding Agents Are the Exception, Not the Rule'
summary: "The generation vs analysis asymmetry—why coding agent success patterns don't transfer to knowledge work domains"
publishedAt: '2025-12-22'
tags: ['AI Agents', 'Coding Agents', 'Cursor', 'Model Capabilities']
featured: false
...
{/\* ==========================================================================
PUBLICATION 7: MODEL CAPABILITIES - CODING AGENT EXCEPTION
STATUS: OUTLINE (Part 1) - Content drafted, ready for review
==========================================================================

SOURCE: Aggregations/Theme_Model_Capabilities.md (PRIMARY SOURCE)
ADDITIONAL: key_quotes_database.md (Theme 6: Model Capabilities)

SECTION STRUCTURE (from task requirements):

1.  Hook (don't extrapolate from Cursor/Devin success) - COMPLETE
2.  Only Two Killer Apps (Tushar/CodeForge: search and coding) - COMPLETE
3.  Generation vs Analysis Asymmetry (structured outputs, immediate verification) - COMPLETE
4.  Cost Disadvantage Reality (3-5x more expensive than offshore labor) - COMPLETE
5.  Why Analysis Remains Hard - COMPLETE
6.  Why This Matters - COMPLETE
7.  What You Can Do - COMPLETE
8.  The Bottom Line - COMPLETE

QUOTES USED (7 total, exceeds minimum 2-3):

1.  Tushar (CodeForge): "Only two killer apps: search and coding agents"
2.  Tushar (CodeForge): "LLMs excel at generation tasks but struggle with analysis"
3.  Manus Co-Founder: "Model only contributes 30-40%"
4.  Tian (Okta): "We're 3X... 150 integrations"
5.  Tian (Okta): "3-5x more cost than hiring a human"
6.  Mehak (Sybill): "60 million data points per company"
7.  David (Qurrent): "The intelligence is really smart enough"

KEY STATISTICS USED:

- 3x productivity gains (Tian/Okta coding agents)
- 3-5x cost disadvantage (Tian/Okta generic tasks)
- 80% AI-generated code (Manus, one year transformation)
- 30-40% model contribution (Manus)
- 40% context utilization rule (Production Agents Summit)
- 60M data points per company, 600k per deal (Mehak/Sybill)
- 90% pilot failure rate (David/Qurrent)
- 25-tool MCP accuracy cliff to 30% (CC/Vivgrid)
- $400-750/month WTP vs $20/month current (Abhishek/Apna)

TARGET LENGTH: 1,800-2,200 words
ESTIMATED CURRENT LENGTH: ~2,000 words
========================================================================== \*/}
...
When I asked Tushar, founder of CodeForge, about the state of AI agents, his answer was immediate and categorical.
...
Yujian Tan reinforced this point directly: "Outside of coding agents, there's not a lot of agents that I see being put into production or even being used at all right now."
...
The Manus team discovered this asymmetry firsthand. Their co-founder explained:
...
The productivity numbers reflect this asymmetry starkly. Tian Lan at Okta described their experience with coding agents:
...
Three times productivity. Measurable and consistent. Teams that once built 50 integrations now build 150 with the same headcount. The Manus team reported even more dramatic shifts: their AI-generated code went from 20% to 80% within a single year.

But when Tian described attempts to automate customer service with AI agents, the economics inverted entirely.
...
The willingness-to-pay gap further illustrates the disconnect. Abhishek at Apna noted that enterprises would pay $400-750 per month for AI solutions that actually worked. Current offerings charge $20 per month. That gap of 20 to 37 times exists because vendors cannot deliver sufficient value at higher price points. The technology does not yet justify enterprise pricing for analysis-heavy workflows.
...
Mehak at Sybill explained the scale of the problem:
...
David at Qurrent summarized the current state of model intelligence:
...
First, it prevents wasted investment. Organizations pouring resources into AI-powered customer service, research automation, or strategic analysis tools should expect economics that look nothing like coding agent success stories. The 90% pilot failure rate that David at Qurrent documented is not coincidence. It reflects the fundamental mismatch between model capabilities and analysis requirements.
