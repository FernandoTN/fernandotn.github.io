...
2.  Only Two Killer Apps (a developer/an AI coding company: search and coding) - COMPLETE
...
1.  a developer at an AI coding company: "Only two killer apps: search and coding agents"
2.  a developer at an AI coding company: "LLMs excel at generation tasks but struggle with analysis"
3.  an AI autonomous agent company Co-Founder: "Model only contributes 30-40%"
4.  an engineering leader at a major identity company: "We're 3X... 150 integrations"
5.  an engineering leader at a major identity company: "3-5x more cost than hiring a human"
6.  an AI lead at a sales intelligence company: "60 million data points per company"
7.  an enterprise AI deployment expert: "The intelligence is really smart enough"

KEY STATISTICS USED:

- 3x productivity gains (the engineering leader/a major enterprise identity company coding agents)
- 3-5x cost disadvantage (the engineering leader/a major enterprise identity company generic tasks)
- 80% AI-generated code (an AI autonomous agent company, one year transformation)
- 30-40% model contribution (an AI autonomous agent company)
- 40% context utilization rule (Production Agents Summit)
- 60M data points per company, 600k per deal (the AI lead/an AI sales intelligence company)
- 90% pilot failure rate (the practitioner/an AI agent orchestration company)
- 25-tool MCP accuracy cliff to 30% (CC/an AI infrastructure company)
- $400-750/month WTP vs $20/month current (an engineering leader/a workforce platform)
...
The productivity numbers reflect this asymmetry starkly. an engineering leader at a major identity company at a major enterprise identity company described their experience with coding agents:
